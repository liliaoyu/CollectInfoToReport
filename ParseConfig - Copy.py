...
def ParseTxt(strFileNameConf):
    ...
    for strLine in oFile:
        ...
        if listPair[0] == 'AbsolutePathDefault':
            ...
            oMyLog.info('strAbsolutePathDefault = ' + strAbsolutePathDefault)
        ...
        #MyLog.warning dictConf
    oFile.close()
    return dictConf

def UpdateXls(dictConf):
    nFiles = len(dictConf.get('AbsolutePaths'))
    ...
    for nIndex in range(nFiles):
        ...
        for nRow in range(3):
            ...
            nRowTarget = nRow + 1
            nColTarget = nIndex + 1
            # MyLog.warning nRowSource, nColSource, nRowTarget, nColTarget
